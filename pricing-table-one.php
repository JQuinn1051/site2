                ...
                <div class="container z-1000">
                    <div class="row gx-5 align-items-center">
                        <div class="col-lg-2 d-lg-block d-none">
                            <img src="images/covers/1.webp" class="img-fluid wow fadeInUp" alt="">
                        </div>
                        <div class="col-lg-6">
                            <div class="subtitle wow fadeInUp mb-3">Server hosting</div>
                            <h2 class="wow fadeInUp mb20" data-wow-delay=".2s">Thunder and City</h2>
            ...
            <section class="no-top">
                <div class="container">
                    <div class="row">
                        ...
                        <div class="col-xl-3 col-lg-6 mb-sm-30 wow fadeInRight" data-wow-delay=".2s">
                        ...
                        <div class="col-xl-3 col-lg-6 mb-sm-30 wow fadeInRight" data-wow-delay=".4s">
                            <div class="de_pricing-table type-2">
                                <div class="d-head">
                                    <h3>10 Slots</h3>
                                </div>
                        ...
                        <div class="col-xl-3 col-lg-6 mb-sm-30 wow fadeInRight" data-wow-delay=".6s">
                        ...
                        <div class="col-xl-3 col-lg-6 mb-sm-30 wow fadeInRight" data-wow-delay=".8s">
                            <div class="de_pricing-table type-2">
                                <div class="d-head">
                                    <h3>Custom</h3>
                                </div>
