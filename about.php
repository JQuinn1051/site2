                ...
                <div class="container">
                    <div class="row">
                        <div class="col-lg-8 offset-lg-2">
                            <div class="row gx-5">
                                <div class="col-lg-6 col-md-4 wow fadeInRight" data-wow-delay=".2s">
                                    <h4>Our Vision</h4>
                                ...
                                <div class="col-lg-6 col-md-4 wow fadeInRight" data-wow-delay=".4s">
                                    <h4>Our Mission</h4>
                ...
                <div class="container">
                    <div class="row">
                        <div class="col-md-3">
                            ...
                            <h2 class="wow fadeInUp">Behind the scene</h2>
                        </div>
