                                ...
                                <div class="sw-caption">
                                    <div class="container">
                                        <div class="row gx-5 align-items-center">
                                            ...
                                            <div class="col-lg-6">
                                                <p class="slider-text">Aute esse non magna elit dolore dolore dolor sit est. Ea occaecat ea duis laborum reprehenderit id cillum tempor cupidatat qui nisi proident nostrud dolore.</p>
                                                ...
                                                <a class="btn-main mb10" href="pricing-table-one">Order Your Game Server Now</a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
            ...
            <section class="no-bottom">
                <div class="container">
                    <div class="row g-4">
                        ...
                        <div class="col-lg-3 wow fadeInRight" data-wow-delay="0s">
                            <div>
                    ...
                    <div class="row align-items-center gx-5">
                        ...
                        <div class="col-lg-6">
                            ...
                            <ul class="de-server s2 wow fadeInUp">
                                ...
                                <li><a href="locations">View all available servers</a></li>
                            </ul>
