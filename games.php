            ...
            <section class="jarallax">
                ...
                <div class="container z-1000">
                    <div class="row align-items-center">
                        ...
                        <div class="col-lg-6">
                            <h2 class="wow fadeInUp" data-wow-delay=".2s">Game Collection</h2>
                            <div class="spacer-20"></div>
                        </div>
                        <div class="col-md-6">
                            <ul id="filters" class="float-end wow fadeInUp" data-wow-delay="0s">
                    ...
                    <div id="gallery" class="row g-4">
                        <div class="col-lg-3 item popular survival">
                            <div class="de-item">
                                <div class="d-overlay">
                                    <div class="d-label">
                                        20% OFF
                        ...
                        <div class="col-lg-3 item sandbox">
                            <div class="de-item">
                                <div class="d-overlay">
                                    <div class="d-label">
                                        20% OFF
                        ...
                        <div class="col-lg-3 item survival">
                            <div class="de-item">
                                <div class="d-overlay">
                                    <div class="d-label">
                                        20% OFF
                        ...
                        <div class="col-lg-3 item popular fps">
                            <div class="de-item">
                                <div class="d-overlay">
                                    <div class="d-label">
                                        20% OFF
                        ...
                        <div class="col-lg-3 item popular">
                            <div class="de-item">
                                <div class="d-overlay">
                                    <div class="d-label">
                                        20% OFF
                        ...
                        <div class="col-lg-3 item popular sandbox">
                            <div class="de-item">
                                <div class="d-overlay">
                                    <div class="d-label">
                                        20% OFF
