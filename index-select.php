...
<body class="dark-scheme">
                        ...
                        <div class="de-flex sm-pt10">
                            ...
                            <div class="de-flex-col">
                                <div class="menu_side_area">
                                    <a href="https://themeforest.net/user/designesia" class="btn-line">Buy Now</a>
                ...
                <div class="container z-1000">
                    <div class="row align-items-center">                        
                        ...
                        <div class="col-lg-5">
                            ...
                            <a class="btn-main wow fadeInUp" href="#section-preview">Explore Playhost</a>
                        </div>
                    ...
                    <div class="row g-3">
                        ...
                        <div class="col-lg-4 col-md-6 wow fadeInRight" data-wow-delay=".2s">
                            <div class="padding40 h-100 rounded-10" data-bgcolor="rgba(255,255,255,.015)">
                                <img src="demo/icons/booststrap-5.png" class="w-100px mb-3" alt="">
                        ...
                        <div class="col-lg-4 col-md-6 wow fadeInRight" data-wow-delay=".4s" >
                            <div class="padding40 h-100 rounded-10" data-bgcolor="rgba(255,255,255,.015)">
                                <img src="demo/icons/flash.png" class="w-100px mb-3" alt="">
                                <h4>Blazing Speed</h4>
                        ...
                        <div class="col-lg-4 col-md-6 wow fadeInRight" data-wow-delay=".6s">
                            <div class="padding40 h-100 rounded-10" data-bgcolor="rgba(255,255,255,.015)">
                                <img src="demo/icons/responsive.png" class="w-100px mb-3" alt="">
                        ...
                        <div class="col-lg-4 col-md-6 wow fadeInRight" data-wow-delay=".2s">
                            <div class="padding40 h-100 rounded-10" data-bgcolor="rgba(255,255,255,.015)">
                                <img src="demo/icons/font-awesome-6.png" class="w-100px mb-3" alt="">
                        ...
                        <div class="col-lg-4 col-md-6 wow fadeInRight" data-wow-delay=".4s">
                            <div class="padding40 h-100 rounded-10" data-bgcolor="rgba(255,255,255,.015)">
                                <img src="demo/icons/swiper-slider.png" class="w-100px mb-3" alt="">
                                <h4>Swiper Slider</h4>
                        ...
                        <div class="col-lg-4 col-md-6 wow fadeInRight" data-wow-delay=".6s">
                            <div class="padding40 h-100 rounded-10" data-bgcolor="rgba(255,255,255,.015)">
                                <img src="demo/icons/recaptcha.png" class="w-100px mb-3" alt="">
                                <h4>Form with reCAPTCHA</h4>
                                    All forms on Playhost using reCAPTCHA by Google to protects your site from spam and abuse.
                            </div>
                        </div>

                        <div class="col-lg-4 col-sm-6 mb-sm-30 wow fadeIn" data-wow-delay="0s">
                            <div class="padding40 text-center" data-bgcolor="rgba(0, 0, 0, .25)">
                                <h2 class="mb-1">21,000+</h2>
                                Clients Trust Designesia
                            </div>
                        </div>
                        <div class="col-lg-4 col-sm-6 mb-sm-30 wow fadeIn" data-wow-delay=".2s">
                            <div class="padding40 text-center" data-bgcolor="rgba(0, 0, 0, .25)">
                                <h2 class="mb-1">15</h2>
                                Years of Experiences
                            </div>
                        </div>
                        <div class="col-lg-4 col-sm-6 mb-sm-30 wow fadeIn" data-wow-delay=".4s">
                            <div class="padding40 text-center" data-bgcolor="rgba(0, 0, 0, .25)">
                        ...
                        <div class="col-md-12 wow fadeInUp">
                            ...
                            <div class="row gh-4 sequence">
                                ...
                                <div class="col-md-4 gallery-item text-center mb20">
                                    <a class="d_demo_img wow" target="_blank" href="index">
                                        <span class="d-overlay"><span>Live Preview</span></span>
                                        <img src="demo/preview/homepage-1.webp" class="color img-fluid wow " alt="">
                                    </a>
                                    <h5 class="s2">Homepage Main</h5>
                                </div>                     

                                <div class="col-md-4 gallery-item text-center mb20">
                                    <a class="d_demo_img wow" target="_blank" href="homepage-2">
                                        <span class="d-overlay"><span>Live Preview</span></span>
                                        <img src="demo/preview/homepage-2.webp" class="color img-fluid wow " alt="">
                                    </a>
                                    <h5 class="s2">Homepage Two</h5>
                                </div>

                                <div class="col-md-4 gallery-item text-center mb20">
                                    <a class="d_demo_img wow" target="_blank" href="games">
                                        <span class="d-overlay"><span>Live Preview</span></span>
                                        <img src="demo/preview/games.webp" class="color img-fluid wow " alt="">
                                    </a>
                                    <h5 class="s2">Games</h5>
                                </div>

                                <div class="col-md-4 gallery-item text-center mb20">
                                    <a class="d_demo_img wow" target="_blank" href="pricing-table-one">
                                        <span class="d-overlay"><span>Live Preview</span></span>
                                        <img src="demo/preview/server-single-one.webp" class="color img-fluid wow " alt="">
                                    </a>
                                    <h5 class="s2">Pricing Table One</h5>
                                </div>

                                <div class="col-md-4 gallery-item text-center mb20">
                                    <a class="d_demo_img wow" target="_blank" href="pricing-table-two">
                                        <span class="d-overlay"><span>Live Preview</span></span>
                                        <img src="demo/preview/server-single-two.webp" class="color img-fluid wow " alt="">
                                    </a>
                                    <h5 class="s2">Pricing Table Two</h5>
                                </div>

                                <div class="col-md-4 gallery-item text-center mb20">
                                    <a class="d_demo_img wow" target="_blank" href="locations">
                                        <span class="d-overlay"><span>Live Preview</span></span>
                                        <img src="demo/preview/locations.webp" class="color img-fluid wow " alt="">
                                    </a>
                                    <h5 class="s2">Locations</h5>
                                </div>

                                <div class="col-md-4 gallery-item text-center mb20">
                                    <a class="d_demo_img wow" target="_blank" href="knowledgebase">
                                        <span class="d-overlay"><span>Live Preview</span></span>
                                        <img src="demo/preview/knowledgebase.webp" class="color img-fluid wow " alt="">
                                    </a>
                                    <h5 class="s2">Knowledgebase</h5>
                                </div>

                                <div class="col-md-4 gallery-item text-center mb20">
                                    <a class="d_demo_img wow" target="_blank" href="faq">
                                        <span class="d-overlay"><span>Live Preview</span></span>
                                ...
                                <div class="col-md-4 gallery-item text-center mb20">
                                    <a class="d_demo_img wow" target="_blank" href="contact">
                                        <span class="d-overlay"><span>Live Preview</span></span>
                                        <img src="demo/preview/contact.webp" class="color img-fluid wow " alt="">
                                    </a>
                                    <h5 class="s2">Contact</h5>
                                </div>

                                <div class="col-md-4 gallery-item text-center mb20">
                                    <a class="d_demo_img wow" target="_blank" href="news">
                                        <span class="d-overlay"><span>Live Preview</span></span>
                                ...
                                <div class="col-md-4 gallery-item text-center mb20">
                                    <a class="d_demo_img wow" target="_blank" href="about">
                                        <span class="d-overlay"><span>Live Preview</span></span>
                                        <img src="demo/preview/about.webp" class="color img-fluid wow " alt="">
                                    </a>
                                    <h5 class="s2">About</h5>
                                </div>

                                <div class="col-md-4 gallery-item text-center mb20">
                                    <a class="d_demo_img wow" target="_blank" href="affliate">
                                        <span class="d-overlay"><span>Live Preview</span></span>
                                        <img src="demo/preview/affliate.webp" class="color img-fluid wow " alt="">
                                    </a>
                                    <h5 class="s2">Affliates</h5>
                                </div>
    ...
    <div id="buy-now">
        <a class="btn-buy" href="https://themeforest.net/cart/add_items?ref=designesia&item_ids=48636843" target="_blank">Buy on <img src="demo/envato.png" class="" alt=""></a>
    </div>
    <!-- Javascript Files
    ================================================== -->
