                    ...
                    <div class="col-md-12">
                        <div class="de-flex sm-pt10">
                            ...
                            <div class="de-flex-col header-col-mid">
                                <ul id="mainmenu">
                                    <li><a class="menu-item" href="index">Home</a>

                                    </li>
                                    <li>
                                        <a class="menu-item" href="games">Game Servers</a>
                                        <ul>
                                            <li><a class="menu-item" href="games">Games Server List</a></li>
                                            <li><a class="menu-item" href="pricing-table-one">Pricing Table One</a></li>
                                            <li><a class="menu-item" href="pricing-table-two">Pricing Table Two</a></li>
                                        </ul>
                                    </li>
                                    <li><a class="menu-item" href="locations">Locations</a></li>
                                    <li><a class="menu-item" href="#">Support</a>
                                        <ul>
                                            <li><a class="menu-item" href="knowledgebase">Knowledgebase</a></li>
                            ...
                            <div class="de-flex-col">
                                <div class="menu_side_area">
                                    <a href="games.html" class="btn-line">Get Hosting</a>
                ...
                <div class="swiper-container-wrapper">
                  ...
                  <div class="swiper-container gallery-top">
                    ...
                    <div class="swiper-wrapper">
                      <!-- Slides -->
                      <div class="swiper-slide" data-bgimage="url(images/slider/5.webp)">
                        <div class="sw-caption s2">
                            <div class="container">
                                <div class="row gx-5 align-items-center">
                                    <div class="col-lg-8 offset-lg-2 mb-sm-30">
                                        <div class="subtitle blink mb-4">Servers Are Available</div>
                                        <h1 class="slider-title text-uppercase mb-1">Cyber Nexus</h1>
                                    </div>
                                    <div class="col-lg-6 offset-lg-3">
                                        <p class="slider-text">Aute esse non magna elit dolore dolore dolor sit est. Ea occaecat ea duis laborum reprehenderit id cillum tempor cupidatat qui nisi proident nostrud dolore id do eiusmod. Lorem ipsum non labore.</p>
                                        <div class="spacer-10"></div>
                                        <a class="btn-main mb10" href="games">Order Your Game Server Now</a>
                                    </div>
                                </div>
                            </div>
                        </div>
                      ...
                      <div class="swiper-slide" data-bgimage="url(images/slider/6.webp)">
                        <div class="sw-caption s2">
                            <div class="container">
                                <div class="row gx-5 align-items-center">
                                    <div class="col-lg-8 offset-lg-2 mb-sm-30">
                                        <div class="subtitle blink mb-4">Servers Are Available</div>
                                        <h1 class="slider-title text-uppercase mb-1">Ancient Realms</h1>
                                    </div>
                                    <div class="col-lg-6 offset-lg-3">
                                        <p class="slider-text">Aute esse non magna elit dolore dolore dolor sit est. Ea occaecat ea duis laborum reprehenderit id cillum tempor cupidatat qui nisi proident nostrud dolore id do eiusmod. Lorem ipsum non labore.</p>
                                        <div class="spacer-10"></div>
                      ...
                      <div class="swiper-slide" data-bgimage="url(images/slider/7.webp)">
                        <div class="sw-caption s2">
                            <div class="container">
                                <div class="row gx-5 align-items-center">
                                    <div class="col-lg-8 offset-lg-2 mb-sm-30">
                                        <div class="subtitle blink mb-4">Servers Are Available</div>
                                        <h1 class="slider-title text-uppercase mb-1">Thunder and City</h1>
                                    </div>
                                    <div class="col-lg-6 offset-lg-3">
                                        <p class="slider-text">Aute esse non magna elit dolore dolore dolor sit est. Ea occaecat ea duis laborum reprehenderit id cillum tempor cupidatat qui nisi proident nostrud dolore id do eiusmod. Lorem ipsum non labore.</p>
                                        <div class="spacer-10"></div>
                      ...
                      <div class="swiper-slide" data-bgimage="url(images/slider/8.webp)">
                        <div class="sw-caption s2">
                            <div class="container">
                                <div class="row gx-5 align-items-center">
                                    <div class="col-lg-8 offset-lg-2 mb-sm-30">
                                        <div class="subtitle blink mb-4">Servers Are Available</div>
                                        <h1 class="slider-title text-uppercase mb-1">Raceway Revolution</h1>
                                    </div>
                                    <div class="col-lg-6 offset-lg-3">
                                        <p class="slider-text">Aute esse non magna elit dolore dolore dolor sit est. Ea occaecat ea duis laborum reprehenderit id cillum tempor cupidatat qui nisi proident nostrud dolore id do eiusmod. Lorem ipsum non labore.</p>
                                        <div class="spacer-10"></div>
                    ...
                    <div class="row gx-5">
                        <div class="col-lg-4 mb-sm-30">
                            <h3>Server Near You</h3>
                                ...
                                <a class="btn-line lg-w-50" href="locations">Choose a Server</a>
                        </div>
                        <div class="col-lg-4 mb-sm-30">
                            <h3>Affiliates Program</h3>
                                <p>Duis aliqua ex nostrud eiusmod esse esse reprehenderit non esse elit dolore sed qui cupidatat magna occaecat officia ut exercitation eu sed est elit id commodo.</p>
                                <a class="btn-line lg-w-50" href="affliate">Become an Affiliate</a>
                        </div>
                        <div class="col-lg-4 mb-sm-30">
                            <h3>Need Support?</h3>
                                <p>Duis aliqua ex nostrud eiusmod esse esse reprehenderit non esse elit dolore sed qui cupidatat magna occaecat officia ut exercitation eu sed est elit id commodo.</p>
                                <a class="btn-line lg-w-50" href="knowledgebase">Contact Support</a>
                        </div>
                    </div>
                </div>
            </section>
                ...
                <div class="container z-1000">
                    <div class="row align-items-center">
                        ...
                        <div class="col-lg-6 text-lg-end">
                            <a class="btn-main mb-sm-30" href="games">View all games</a>
                        </div>
                    </div>
                    <div class="row g-4 sequence">
                            ...
                            <div class="de-item wow">
                                <div class="d-overlay">
                                    ...
                                    <div class="d-text">
                                        ...
                                        <a class="btn-main btn-fullwidth" href="pricing-table-one">Order Now</a>
                                    </div>
                                </div>
                        ...
                        <div class="col-lg-3 gallery-item sandbox">
                            <div class="de-item wow">
                                <div class="d-overlay">
                                    <div class="d-label">
                                        20% OFF
            ...
            <section class="no-top no-bottom jarallax">
                <div class="container">
                    <div class="row">
                        ...
                        <div class="col-lg-6">
                            <h2 class="wow fadeInUp mb20" data-wow-delay=".2s">25 servers available worldwide for your game.</h2>
                        </div>
                        <div class="col-lg-6">
                            ...
                            <div class="padding60 sm-padding40 jarallax position-relative">
                                ...
                                <div class="row">
                                    <div class="col-lg-6">
                                        ...
                                        <p class="wow fadeInUp">Aute esse non magna elit dolore dolore dolor sit est. Ea occaecat ea duis laborum reprehenderit id cillum tempor cupidatat qui nisi proident nostrud dolore.</p>
                                        <div class="spacer-10"></div>
                                        <a class="btn-main mb10 wow fadeInUp" href="games">Order Your Game Server Now</a>
                                    </div>
                                </div>
            ...
            <section class="no-bottom">
                <div class="container">
                    <div class="row">
                        ...
                        <div class="col-lg-3 mb-sm-30 wow fadeInRight" data-wow-delay="0s">
                            <div class="padding30 rounded-10" data-bgimage="rgba(255, 255, 255, .03)">
                        ...
                        <div class="col-lg-3 mb-sm-30 wow fadeInRight" data-wow-delay=".2s">
                            <div class="padding30 rounded-10" data-bgimage="rgba(255, 255, 255, .03)">
                        ...
                        <div class="col-lg-3 mb-sm-30 wow fadeInRight" data-wow-delay=".4s">
                            <div class="padding30 rounded-10" data-bgimage="rgba(255, 255, 255, .03)">
                        ...
                        <div class="col-lg-3 mb-sm-30 wow fadeInRight" data-wow-delay=".6s">
                            <div class="padding30 rounded-10" data-bgimage="rgba(255, 255, 255, .03)">
                            ...
                            <div class="padding60 sm-padding40 jarallax position-relative">
                                ...
                                <div class="row">
                                    <div class="col-lg-6">
                                        ...
                                        <a href="download"><img src="images/misc/download-appstore.webp" class="img-fluid mb-sm-20" alt="download"></a>&nbsp;
                                        <a href="download"><img src="images/misc/download-playstore.webp" class="img-fluid mb-sm-20" alt="download"></a>
                                    </div>
                                </div>
                ...
                <div class="row gx-5">
                    ...
                    <div class="col-lg-4">
                        <div class="widget">
                            ...
                            <div class="spacer-10"></div>
                            <h5>Contact Us</h5>
                            <a href="mailto:support@xvps.co.uk">support@xvps.co.uk</a>
                           <p>Phone: --</p>
                        </div>
                    </div>
                </div>
